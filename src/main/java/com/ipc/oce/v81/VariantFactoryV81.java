 ...
 *
 */
class VariantFactoryV81 extends VariantFactory{
	private static final transient Log LOG = LogFactory.getLog(VariantFactoryV81.class);
	
	public VariantFactoryV81(){
