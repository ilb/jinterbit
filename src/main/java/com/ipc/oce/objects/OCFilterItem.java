...
public class OCFilterItem extends OCObject {
	 ...
	 * @throws JIException
	 */
	public Boolean isUsage() throws JIException {
		return get("Usage").getObjectAsBoolean();
	}
	 ...
	 * @throws JIException
	 */
	public Boolean getUsage() throws JIException {
		return get("Usage").getObjectAsBoolean();
	}
	 ...
	 * фильтрации.
	 *
	 * @param usage признак использования
	 * @throws JIException
	 */
	public void setUsage(boolean usage) throws JIException {
		put("Usage", new JIVariant(usage));
	}
	 ...
	 *
	 * @param variant Значение сравнения
	 * @param use Признак использования отбора по значению
	 * @throws JIException
	 */
