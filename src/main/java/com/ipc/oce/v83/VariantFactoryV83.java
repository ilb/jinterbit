 ...
 *
 */
class VariantFactoryV83 extends VariantFactory{
	private static final transient Log LOG = LogFactory.getLog(VariantFactoryV83.class);
	
	public VariantFactoryV83(){
